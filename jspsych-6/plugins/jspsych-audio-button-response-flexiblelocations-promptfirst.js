...
jsPsych.plugins["audio-button-response-flexiblelocations-promptfirst"] = (function() {
	var plugin = {};

	jsPsych.pluginAPI.registerPreload('audio-button-response-flexiblelocations-promptfirst', 'stimulus', 'audio');
